...
def print_en(plaintext, encrypted_message,date_now,binary):
    ...
    print("Just published a message to topic Skinny at "+ date_now)
...
cipher = SkinnyCipher(key, key_size=128, block_size=64, mode='ECB')
# cipher = SkinnyCipher(key, 128, 128, 'CBC', 0x123456789ABCDEF0)
message ={}
